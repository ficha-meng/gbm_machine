...
public:
  ...
  */
  virtual void ResetShrinkageRate(float shrinkage_rate) = 0;
  ...
  */
  virtual std::vector<float> GetEvalAt(int data_idx) const = 0;
  ...
  */
  virtual std::vector<float> PredictRaw(const float* feature_values) const = 0;
  ...
  * \return Prediction result for this record
  */
  virtual std::vector<float> Predict(const float* feature_values) const = 0;
  ...
  */
  virtual std::vector<int> PredictLeafIndex(
    const float* feature_values) const = 0;
  ...
  */
  ...
  virtual void SaveModelToFileFicha(int num_iterations, const char* path, const char* filename, int max_num_leaves,int shift_bit,int width,int height) const = 0;
  /*!
