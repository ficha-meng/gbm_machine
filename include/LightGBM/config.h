...
public:
  int shift_bit = 15; // for model trans to ficha short
  ...
  std::string data_filename = "DIR.data";
  std::vector<std::string> valid_data_filenames;
  std::string output_model = "LightGBM_model.output";
