...
public:
  ...
  inline void PushOneRow(int tid, data_size_t row_idx, const std::vector<float>& feature_values) {
  ...
  inline void PushOneRow(int tid, data_size_t row_idx, const std::vector<std::pair<int, float>>& feature_values) {
  ...
  inline void PushOneColumn(int tid, data_size_t col_idx, const std::vector<std::pair<int, float>>& feature_values) {
